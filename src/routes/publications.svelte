        ...
        <div class="pubyear">
            ...
            <ul>
                ...
                <li>
                    ...
                    <a target="_self" href="publications/2020_AIED_Conference_Paper.pdf"   class="publication">Kim, D. Y. J, <strong>Winchell, A.</strong>, Waters, A. E., Grimaldi, P. J., Baraniuk, R., & Mozer, M. C. (2020). Inferring student comprehension from highlighting patterns in digital textbooks: An exploration in an authentic learning platform. In S. Sosnovsky, P. Brusilovsky, R. G. Baraniuk, & A. S. Lan (Eds.), Second Workshop on Intelligent Textbooks, Springer.</a>
                </li>
                <li>
                    <a target="_self" href="publications/textbook-annotations-serve.pdf"  class="publication"><strong>Winchell, A.</strong>, Mozer, M. C., Lan, A., Grimaldi, P., & Pashler, H. (2018). Can textbook annotations serve as an early predictor of student learning? In K. E. Boyer & M. Yudelson (Eds.), Proceedings of the 11th International Conference on Educational Data Mining (pp. 431-437). EDM Society Press.</a>
                </li>
                <li>
